...
Selenium::WebDriver::Chrome.driver_path="C:\\Users\\akhan113\\Downloads\\chromedriver_win32\\chromedriver.exe"
driver=Selenium::WebDriver.for :chrome
driver.navigate.to "https://demo.opencart.com/"
driver.manage.window.maximize

driver.find_element(:link,"https://demo.opencart.com/index.php?route=account/account").click
driver.find_element(:link,"https://demo.opencart.com/index.php?route=account/login").click
driver.find_element(:name,"email").send_keys("shuchi.sinha@wipro.com")
driver.find_element(:name,"password").send_keys("wipro@123")
...
driver.find_element(:link,"https://demo.opencart.com/index.php?route=product/category&path=24").click
driver.find_element(:link,"https://demo.opencart.com/index.php?route=product/category&path=24").click
...
driver.find_element(:class,"close").click
driver.find_element(:link,"https://demo.opencart.com/index.php?route=product/compare").click
driver.find_element(:link,"https://demo.opencart.com/index.php?route=product/product&product_id=28").click
String canon1=driver.find_element(:xpath,"//li[contains(text(),'Tri-band')]").getText()
f = File.new('C:\\Users\\SU376503\\Documents\\debug.txt', 'w')
f.write(canon1)
f.close

driver.find_element(:id,"button-cart").click
driver.find_element(:link,"https://demo.opencart.com/index.php?route=product/product&product_id=28").click
driver.find_element(:link,"https://demo.opencart.com/index.php?route=checkout/cart").click
driver.find_element(:link,"https://demo.opencart.com/index.php?route=checkout/checkout").click
...
driver.find_element(:link,"https://demo.opencart.com/index.php?route=account/account").click
driver.find_element(:link,"https://demo.opencart.com/index.php?route=account/order").click
...
driver.find_element(:link,"https://demo.opencart.com/index.php?route=account/newsletter").click
driver.find_element(:name,"newsletter").click
driver.find_element(:value,"Continue").click
driver.find_element(:link,"https://demo.opencart.com/index.php?route=product/special").click
driver.find_element(:id,"list-view").click
driver.find_element(:link,"https://demo.opencart.com/index.php?route=account/account").click
driver.find_element(:link,"https://demo.opencart.com/index.php?route=account/logout").click