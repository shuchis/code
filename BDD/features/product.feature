Feature: Opencart Application TC02
  Scenario: Product Comparison
    ...
    Then I click the Login link from the MyAccount
    And I passed "shuchi.sinha@wipro.com" Login
    ...
    And I passed "Shuchi" first name in the Billing Details
    And I passed "Sinha" second name in the billing Details
    And I passed "Wipro Limited" address in the billing Details
    And I passed "Hyderabad" city in the billing Details
    And I passed "500032" post code in the billing Details
    And I select "India" from "country_id" combo1
    And I select "Telangana" from "zone_id" combo1
