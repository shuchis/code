...
Then(/^I click the Register link from the MyAccount$/) do
  $driver.link(:href=>"https://demo.opencart.com/index.php?route=account/login").click
end
...
$driver.link(:href=> "https://demo.opencart.com/index.php?route=product/category&path=24").click
end
...
And(/^I clicked on product comparison link$/) do
  $driver.link(:href=> "https://demo.opencart.com/index.php?route=product/compare").click

end

And(/^I clicked on HTC phone$/) do
  $driver.link(:href=> "https://demo.opencart.com/index.php?route=product/product&product_id=29").click
...
And(/^I clicked on Shopping cart$/) do
  $driver.link(:href=> "https://demo.opencart.com/index.php?route=checkout/cart").click

end

And(/^I clicked on Checkout link$/) do
  $driver.link(:href=> "https://demo.opencart.com/index.php?route=checkout/checkout").click
...
Then(/^The Text should appear as "([^"]*)"$/) do |arg|
  checktext= $driver.link(:href=> "https://demo.opencart.com/index.php?route=checkout/success").text
...
And(/^I clicked on back and My accounts$/) do
  $driver.link(:href=> "https://demo.opencart.com/index.php?route=account/account").click
  
end

And(/^I clicked on Order History$/) do
  $driver.link(:href=> "https://demo.opencart.com/index.php?route=account/order").click
...
And(/^I clicked on Newletter$/) do
  $driver.link(:href=> "https://demo.opencart.com/index.php?route=account/newsletter").click
...
And(/^I clicked on Extra special$/) do
  $driver.link(:href=> "https://demo.opencart.com/index.php?route=product/special").click
