...
Then(/^I click the Register link from the MyAccount dropdown$/) do
  $driver.link(:href=>"https://demo.opencart.com/index.php?route=account/register").click
end
...
Then(/^I clicked on the contact Link$/) do
  $driver.link(:href=>"https://demo.opencart.com/index.php?route=information/contact").click
end
...
And(/^I clicked on Continue in contact Us Page$/) do
  $driver.link(:href=>"https://demo.opencart.com/index.php?route=common/home").click
end

Then(/^I clicked the Samsung Galaxy Tab on home page$/) do
  $driver.link(:href=> "https://demo.opencart.com/index.php?route=product/category&path=57").click

  $driver.img(:src=>"https://demo.opencart.com/image/cache/catalog/demo/samsung_tab_1-228x228.jpg").click
end
...
And(/^I clicked on wishlist link$/) do
  $driver.link(:href=>"https://demo.opencart.com/index.php?route=account/wishlist").click
...
Then(/^I removed the content from wishlist$/) do
  $driver.link(:href=>"https://demo.opencart.com/index.php?route=account/wishlist&remove=49").click
end
...
And(/^I clicked the logout button$/) do
  ...
  $driver.link(:href=>"https://demo.opencart.com/index.php?route=account/logout").click
end
